...
| **Navigation**  | Header and footer menu editor — repeatable link rows; the target picker lists Home / All products / Cart, then **every custom page by name**, then Category / Collection / Custom URL. An **"Add all categories"** button drops one row per category so they can be reordered / removed individually; footer note.                                                      |
