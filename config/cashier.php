...
return [
    ...
    */
    ...
    'mock_checkout' => env('BILLING_MOCK', false),
    ...
    */
    ...
    // 'stripe' is used by the storefront one-off payment webhook, so Cashier's
    // subscription webhook lives under a distinct path.
